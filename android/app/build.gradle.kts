...
android {
    namespace = "com.example.focustalk_app"
    ...
    defaultConfig {
        ...
        minSdk = 22  // Required by usage_stats plugin (minimum Android 5.1)
...
dependencies {
    // Core library desugaring for Java 8+ API support (required by flutter_local_notifications)
